...
def main():
    ...
    # move unix-meshed-delaunay since it is fixed
    shutil.copy(args['path']+ "/colmap/stereo/meshed-delaunay.ply", args['path']+"/colmap/stereo/meshed-delaunay-eolpb.ply")
    shutil.copy(args['path']+ "/colmap/stereo/unix-meshed-delaunay.ply", args['path']+"/colmap/stereo/meshed-delaunay.ply")
